...
/****** Object:  Table [dbo].[SubCategories]    Script Date: 13-07-2023 23:28:11 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[SubCategories] ADD  CONSTRAINT [DF_SubCategories_CreatedDate]  DEFAULT (getdate()) FOR [CreatedDate]
GO

ALTER TABLE [dbo].[SubCategories] ADD  CONSTRAINT [DF_SubCategories_UpdatedDate]  DEFAULT (getdate()) FOR [UpdatedDate]
GO
